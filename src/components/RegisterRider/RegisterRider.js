...
const RegisterRider = () => {
  ...
  const onSubmit = (data, e) => {
    ...
    formData.append("licencePic", data.licencePic[0]);
    formData.append("nidPic", data.nidPic[0]);
    formData.append("profilePic", data.profilePic[0]);
    formData.append("vehicleModal", data.vehicleModal);
              ...
              <Row>
                <Col lg={6} md={6} xs={12}>
                  ...
                  <input
                    ...
                    required
                  />
                  <label htmlFor="licence" className="image-label">
                    Select driving licence photo{" "}
